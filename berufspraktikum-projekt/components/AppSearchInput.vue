<template>
  <div>
    <input
      ...
      class="block w-full pl-10 pr-3 py-2 truncate leading-5 placeholder-red-600 border border-cyan-500 text-blue-600 focus:border-gray-300 rounded-md focus:outline-none focus:bg-white bg-white"
    />
    <ul
